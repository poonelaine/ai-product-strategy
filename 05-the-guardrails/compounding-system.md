...
- Agent searches RS team reference risk data
- Agent consolidates data and categorizes into signals
- Agent to map signal to company policy and explain “Why it matters”
- Agent rates Risk Score of each information source specific to a factory
- Agent suggests an overall Risk Score of a factory
- Agent suggests action items
